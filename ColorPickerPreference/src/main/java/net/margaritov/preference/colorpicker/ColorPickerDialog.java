...
public class ColorPickerDialog
    ...
    public interface OnColorChangedListener {
        void onColorChanged(int color, String key);
    }

    public ColorPickerDialog(Context context, int initialColor, String key) {
        super(context);
        mKey = key;
        init(initialColor);
    }
    ...
    private void setUp(int color) {
        ...
        mLayout = inflater.inflate(R.layout.dialog_color_picker, null, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.new_color_panel) {
            if (mListener != null) {
                mListener.onColorChanged(mNewColor.getColor(), mKey);
            }
        }
        dismiss();
    }
